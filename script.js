...
const storyData = {
    ...
    meetAlexander: {
        character: 'You',
        text: 'You meet Alexander on an app called Discord. As you chat, you begin to feel a connection.',
        choices: [
            { text: 'Give Jermany a compliment', next: 'compliment' },
            { text: 'Ask Jermany about their interests', next: 'askInterests' }
            { text: 'Decide to push feelings away and leave', next: 'leaving' }
        ]
    },
    ...
    leaving: {
        character: 'You left...',
        text: 'With you leaving your feelings down deep you start to fade from the conversation. Making you and Alexander go your separated ways...',
        choices: [
